            ...
            <div class="page-header navbar navbar-fixed-top">
                <div class="page-header-inner ">
                    ...
                    <ul class="nav navbar-nav navbar-left in">
                        <li><a href="#" class="menu-toggler sidebar-toggler"><span class="glyphicon glyphicon-menu-left"></span></a></li>
                    </ul>
                    <!-- start mobile menu -->
                                ...
                                <div class="chat-sidebar-item">
                                    <div class="chat-sidebar-chat-user">
                                        ...
                                        <div class="chat-sidebar-chat-user-messages">
                                            ...
                                            <div class="post in">
                                                <img class="avatar" alt="" src="<?php echo base_url('/assets/img/doc/doc5.jpg'); ?>" />
                                                <div class="message">
